...
reportgenerator "-title:GymManagementSystem Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:GymManagementSystem Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/gymmanagementsystem_tests
./publish_linux/bin/gymmanagementsystemapp
...
reportgenerator "-title:GymManagementSystem Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" 

"-sourcedirs:src/utility/src;src/utility/header;src/gymmanagementsystem/src;src/gymmanagementsystem/header;src/gymmanagementsystemapp/src;src/gymmanagementsystemapp/header;src/tests/utility;src/tests/gymmanagementsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
reportgenerator "-reports:**/coverage_linux.info" "-targetdir:assets/codecoverageliblinux" "-reporttypes:Badges" "-sourcedirs:src/utility/src;src/utility/header;src/gymmanagementsystem/src;src/gymmanagementsystem/header;src/gymmanagementsystemapp/src;src/gymmanagementsystemapp/header;src/tests/utility;src/tests/gymmanagementsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
cp -R src/gymmanagementsystem/header build_linux/build/Release
...
cp -R src/gymmanagementsystem/header build_linux/build/Debug
