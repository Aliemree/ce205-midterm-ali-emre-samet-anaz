...
call reportgenerator "-title:GymManagementSystem Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:GymManagementSystem Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for GymManagementSystem
call OpenCppCoverage.exe --export_type=binary:gymmanagementsystem_tests_unit_win.cov --sources src\gymmanagementsystem\src --sources src\gymmanagementsystem\header --sources src\tests\gymmanagementsystem -- build_win\build\Debug\gymmanagementsystem_tests.exe

echo Generate Test Coverage Data for GymManagementSystem App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=gymmanagementsystem_tests_unit_win.cov --export_type=cobertura:gymmanagementsystemapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\gymmanagementsystem\src --sources src\gymmanagementsystem\header --sources src\gymmanagementsystemapp\src --sources src\gymmanagementsystemapp\header --sources src\tests\utility --sources src\tests\gymmanagementsystem -- build_win\build\Debug\gymmanagementsystemapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:GymManagementSystem Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/gymmanagementsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/gymmanagementsystem/src;src/gymmanagementsystem/header;src/gymmanagementsystemapp/src;src/gymmanagementsystemapp/header;src/tests/utility;src/tests/gymmanagementsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/gymmanagementsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/gymmanagementsystem/src;src/gymmanagementsystem/header;src/gymmanagementsystemapp/src;src/gymmanagementsystemapp/header;src/tests/utility;src/tests/gymmanagementsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\gymmanagementsystem\header "build_win\build\Release" /E
call robocopy src\gymmanagementsystemapp\header "build_win\build\Release" /E
...
call robocopy src\gymmanagementsystem\header "build_win\build\Debug" /E
call robocopy src\gymmanagementsystemapp\header "build_win\build\Debug" /E
